...
#ifndef HoleParametrization_h
#define HoleParametrization_h 1
...
class HoleParametrization : public G4VPVParameterisation
{
  public:
    ...
    HoleParametrization(
      ...
      int   moduleType, int material );

    virtual ~HoleParametrization();
  ...
  private:
    ...
    std::vector<G4double> fHole_x,fHole_y,fHole_z;
    G4ThreeVector fHoleDimensions;
    std::vector<G4double> fCrystal_x,fCrystal_y,fCrystal_z;
    G4ThreeVector fCrystalDimensions;
    int fType;
