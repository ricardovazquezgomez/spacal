...
// compile with
// g++ -o ../build/energyDeposition energyDeposition.cpp `root-config --cflags --glibs` -Wl,--no-as-needed -lHist -lCore -lMathCore

// calculates energy resolution on the basis of energy deposited in crystals
// the program retrieves the simulation geometry from the input file, runs on the entries of the shower ttree
// and sums the energies deposited in the various volumes
...
int main(int argc, char** argv)
{
  ...
  TH1F *hTotalMod = new TH1F("hTotalMod","hTotalMod",100000,0,100000);
