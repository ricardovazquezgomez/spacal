...
def main(args):
    ...
    for inputFolder in inputFolderList:
        ...
        with open(run_script, "w") as output:
            ...
            output.write( buildFolder + "simReadout -c $CONFIG_F -i $INPUT_F -o $OUTPUT_F1\n\n")
...
# PRUNING REMOVED - To be done separately
...
#            output.write( buildFolder + "pruneSigFormOutput -i " + baseFolderOut + "\n")
        ...
        with open(argsFile, "w") as output:
            for i, inputFile in enumerate(inputfiles):
                ...
                output.write("%s " % (currentFolderOut + output2 + "_" + inputsuffix[i]) )      # OUTPUT_F2=$5
                # output.write("%s " % listFilters[0])                                          # FILTERS=$5
