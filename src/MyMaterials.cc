...
G4Material* MyMaterials::YAG_Ce(double user_lightyield,double scaleFactor)
{
...
G4Material* MyMaterials::Lead_crystal()
{
 G4double density;
  G4NistManager* man = G4NistManager::Instance();
  G4Element* Pb = man->FindOrBuildElement("Pb");
...
G4Material* MyMaterials::Al_crystal()
{
  G4double a, z, density;
  // G4NistManager* man = G4NistManager::Instance();
  // G4Element* Pb = man->FindOrBuildElement("Pb");
...
// fake Aluminum material just to test G4
G4Material* MyMaterials::Cu_crystal()
{
  G4double a, z, density;
  // G4NistManager* man = G4NistManager::Instance();
  // G4Element* Pb = man->FindOrBuildElement("Pb");
...
G4Material* MyMaterials::PureTungsten1()
{
  G4double a, z, density;
  G4NistManager* man = G4NistManager::Instance();
  G4Element* W = man->FindOrBuildElement("W");
...
G4Material* MyMaterials::PureTungsten2()
{
  G4double a, z, density;
  G4NistManager* man = G4NistManager::Instance();
  G4Element* W = man->FindOrBuildElement("W");
...
G4Material* MyMaterials::PureTungsten2_crystal()
{
  G4double a, z, density;
  G4NistManager* man = G4NistManager::Instance();
  G4Element* W = man->FindOrBuildElement("W");
...
G4Material* MyMaterials::GAGG_Ce_Mg(double user_lightyield,double scaleFactor) // Gadolinium Gallium Aluminum Garnet
{
  // ########################################################
...
G4Material* MyMaterials::GAGG_ILM(double user_lightyield,double scaleFactor) // Gadolinium Gallium Aluminum Garnet
{
  // ########################################################
  // ### GAGG:Ce:Mg in a more complete fashion.
  // ### - Index of refraction taken from:
...
G4Material* MyMaterials::GAGG_very_fast(double user_lightyield,double scaleFactor) // Gadolinium Gallium Aluminum Garnet
{
  // ########################################################
  // ### GAGG:Ce:Mg in a more complete fashion.
  // ### - Index of refraction taken from:
...
G4Material* MyMaterials::GYAGG(double user_lightyield,double scaleFactor) // Gadolinium Gallium Aluminum Garnet
{
  // ########################################################
  // ### GAGG:Ce:Mg in a more complete fashion.
  // ### - Index of refraction taken from:
...
G4Material* MyMaterials::GFAG(double user_lightyield,double scaleFactor) // Gadolinium Gallium Aluminum Garnet
{
  // ########################################################
  // ### GAGG:Ce:Mg in a more complete fashion.
  // ### - Index of refraction taken from:
...
G4Material* MyMaterials::GAGG_slow(double user_lightyield,double scaleFactor) // Gadolinium Gallium Aluminum Garnet
{
  // ########################################################
  // ### GAGG:Ce:Mg in a more complete fashion.
  // ### - Index of refraction taken from:
...
G4Material* MyMaterials::GAGG_Ce_Mg_old(double user_lightyield,double scaleFactor) // Gadolinium Gallium Aluminum Garnet
{
  // ################################################
...
G4Material* MyMaterials::Polystyrene(double user_lightyield,double scaleFactor)
{
